...
class TestInit():
  ...
  def test_init(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".sub_start:nth-child(27) .external-modules-add-instance").click()
    element = self.driver.find_element(By.CSS_SELECTOR, ".sub_start:nth-child(27) .external-modules-add-instance")
    self.driver.execute_script("$(\'[name=\"pi-event____7\"] option\').eq(2).prop(\'selected\',true);")
    self.driver.execute_script("$(\'[name=\"pi-field____7\"]\').val(\'file_upload\')")
    self.driver.find_element(By.CSS_SELECTOR, ".sub_start:nth-child(31) .external-modules-add-instance").click()
    element = self.driver.find_element(By.CSS_SELECTOR, ".sub_start:nth-child(31) .external-modules-add-instance")
    self.driver.execute_script("$(\'[name=\"pi-event____8\"] option\').eq(2).prop(\'selected\',true);")
    ...
    self.driver.find_element(By.XPATH, "//a[@aria-label='Click to upload a file in a modal dialog.']//span[contains(text(),'Add signature')]")
    print("ECHOSCREENSHOT")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    self.driver.find_element(By.XPATH, "//a[@aria-label='Click to upload a file in a modal dialog.']//span[contains(text(),'Add signature')]").click()
